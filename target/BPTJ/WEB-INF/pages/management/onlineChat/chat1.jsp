...
<head>
    ...
    <script src="<%=basePath%>>/assets/js/sockjs.js"></script>
    <script>
        var ws = null;
        var url = null;
        var transports = [];
        ...
        function connect() {
            ...
            ws = new WebSocket(wsPath + 'webSocketServer.do');
...
<div>
    <div id="connect-container">
        <input id="radio1" type="radio" name="group1" onclick="updateUrl('<%=basePath%>/websocket');">
