...
function loadPage(e) {
    var t = $(".main");
    $.ajax({
        type: "GET", url: e, dataType: "html", cache: !0, beforeSend: function () {
            t.css("opacity", .5)
        }, success: function (e) {
            Pace.restart();
            $("html, body").animate({scrollTop: 0}, 0);
            t.css({opacity: 0}).html(e).delay(250).animate({opacity: 1}, 500)
...
function activeCharts() {
    ...
    $(".chart-stat").length && (retina() ? $(".chart-stat > .chart").each(function () {
        ...
        } else $(this).css("zoom", .5); else $(this).css("zoom", .5)
...
$(document).ready(function (e) {
    ...
    $("body").on("click",".btn-close",function (t) {
        t.preventDefault();
        e(this).parent().parent().parent().parent().replaceWith("");
    });

    $("body").on("click",".btn-minimize",function (t) {
        t.preventDefault();
...
$("#wizard").formwizard({
    ...
    formOptions: {
        success: function () {
            a($("#wizard .msg"), "You successfully submit this form")
        }, resetForm: !0
    },
    disableUIStyles: !0,
    showSteps: !0
